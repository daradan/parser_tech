...
from .models import AlserProducts, AlserPrices
...
class AlserProductsCrud(ProductsCrud):
    def __init__(self, session: Session):
        super().__init__(session, AlserProducts)


class AlserPricesCrud(PricesCrud):
    def __init__(self, session: Session):
        super().__init__(session, AlserPrices)
